package com.steam.skin.scheduler.getupdates.packet;
...
public class SteamPacketProcessor {
    ...
    public static SteammessagesClientserverAppinfo.CMsgClientPICSProductInfoResponse handleProductInfoResponse(SteamPacket packet) {
        try {
